    ...
    <footer className='w-100 pt-4 flex-shrink-0 '>
      <div className='container pt-4 p-0'>
        <div className='row gy-4 gx-5 footer'>
              ...
              <div className='text-left '>
                <div className='footer-text'>
                  <Link
                    ...
                    href='https://goo.gl/maps/2WDjYgVeBcUKsnTs9'
                    className='fontAdd'
                  >
                    <p>
                      {' '}
                      <i className='fa fa-map' /> Địa chỉ: 198 Mỹ Đình 2, Quận Nam Từ Liêm, Hà Nội
                    </p>
                  </Link>
                  <p className=''>
                    <i className='fa fa-phone fontPhone'></i>Điện thoại: 0989999888
                  </p>
          ...
          <div className='col-lg-2 col-md-6'>
            ...
            <ul className='list-unstyled text-muted '>
              <li>
                <Link href='#' className='text-decoration-none link-text'>
                  Trang chủ
                </Link>
              </li>
              <li>
        ...
        <div className='copyright'>
          ...
          <p>
            {' '}
            &copy; Copyright Duong Thai Huy, Tran Quang Huy, Vi Quoc Thien, Hoang Van Luong Web`s
            Developer
          </p>
        </div>
      </div>
